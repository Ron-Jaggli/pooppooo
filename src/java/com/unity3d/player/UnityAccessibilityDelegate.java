...
class UnityAccessibilityDelegate extends View.AccessibilityDelegate {
    ...
    private AccessibilityManagerAccessibilityStateChangeListenerC0252u0 d;
    ...
    private AccessibilityNodeProvider k = new C0248s0(this);
    ...
    protected static UnityAccessibilityDelegate init(UnityPlayer unityPlayer) {
        ...
        if (unityAccessibilityDelegate.c != null || captioningManager != null) {
            ...
            unityAccessibilityDelegate.a.runOnUiThread(new RunnableC0224k0(unityAccessibilityDelegate, semaphore));
            try {
                semaphore.acquire();
    ...
    public final void a(Configuration configuration) {
        ...
        if (f != this.j) {
            ...
            this.a.invokeOnMainThread((Runnable) new C0227l0(unityPlayer, configuration));
        }
    }

    protected void cleanup() {
        AccessibilityManagerAccessibilityStateChangeListenerC0252u0 accessibilityManagerAccessibilityStateChangeListenerC0252u0 = this.d;
        if (accessibilityManagerAccessibilityStateChangeListenerC0252u0 != null) {
            accessibilityManagerAccessibilityStateChangeListenerC0252u0.cleanup();
        }
        C0256w0 c0256w0 = this.f;
        if (c0256w0 != null) {
            c0256w0.cleanup();
        }
    ...
    protected boolean sendEventForVirtualViewId(int i, int i2) {
        ...
        if (i2 == 32768) {
            ...
            UnityPlayer unityPlayer = this.a;
            Objects.requireNonNull(unityPlayer);
            this.a.invokeOnMainThread((Runnable) new C0233n0(unityPlayer, i));
        }
        if (i2 == 65536) {
            if (this.g == i) {
                this.g = -1;
            ...
            this.a.invokeOnMainThread((Runnable) new C0236o0(unityPlayer2, i));
        }
        return sendAccessibilityEvent(accessibilityEventObtain);
    }

    protected boolean sendEventForVirtualViewIdFromNative(int i, int i2) {
        this.a.runOnUiThread(new RunnableC0230m0(this, i, i2));
        return true;
    }
}
