...
class C0255w {
    ...
    private int A = 3;
    private final CameraDevice.StateCallback x = new C0247s(this);
    private final ImageReader.OnImageAvailableListener y = new C0249t(this);
    private final SurfaceTexture.OnFrameAvailableListener z = new C0251u(this);

    protected C0255w(com.unity3d.player.a.b bVar) {
        this.a = null;
        this.a = bVar;
        e();
    }
    ...
    */
    public static int[] b(android.content.Context r3, int r4) {
        ...
        L51:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.unity3d.player.C0255w.b(android.content.Context, int):int[]");
    }
    ...
    */
    public void g() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.unity3d.player.C0255w.g():void");
    }
    ...
    public final void h() {
        ...
        try {
            CameraCaptureSession cameraCaptureSession = this.r;
            if (cameraCaptureSession == null) {
                createCaptureSession(new C0244r(this));
            } else if (this.A == 2) {
