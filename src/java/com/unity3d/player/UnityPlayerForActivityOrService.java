...
public class UnityPlayerForActivityOrService extends UnityPlayer {
    ...
    public UnityPlayerForActivityOrService(Context context, IUnityPlayerLifecycleEvents iUnityPlayerLifecycleEvents) {
        ...
        b.setOnApplyWindowInsetsListener(new ViewOnApplyWindowInsetsListenerC0234n1(this));
        initialize(b);
    ...
    public void queueDestroy() {
        ...
        runOnUiThread(new RunnableC0231m1(this));
    }

    private void raiseFocusListener(boolean z) {
        I i = this.mOnHandleFocusListener;
        if (i != null) {
            RunnableC0204d1 runnableC0204d1 = ((C0198b1) i).a;
            runnableC0204d1.b = true;
            if (runnableC0204d1.a) {
    ...
    public void configurationChanged(Configuration configuration) {
        ...
        if (isNativeInitialized()) {
            invokeOnMainThread(new RunnableC0243q1(this, new Configuration(configuration)));
        }
    }
    ...
    protected void hideSoftInput() {
        ...
        Semaphore semaphore = new Semaphore(0);
        postOnUiThread(new RunnableC0204d1(this, semaphore, this));
        try {
            try {
    ...
    void pauseUnity() {
        ...
        if (E1.d()) {
            Semaphore semaphore = new Semaphore(0);
            this.m_MainThread.a(isFinishing() ? new RunnableC0237o1(this, semaphore) : new RunnableC0240p1(this, semaphore));
            try {
    ...
    protected void reportSoftInputArea(Rect rect) {
        invokeOnMainThread((Runnable) new C0225k1(this, rect));
    }

    protected void reportSoftInputIsVisible(boolean z) {
        invokeOnMainThread((Runnable) new C0228l1(this, z));
    }

    protected void reportSoftInputSelection(int i, int i2) {
        invokeOnMainThread((Runnable) new C0222j1(this, i, i2));
    }
    ...
    protected void reportSoftInputStr(String str, int i, boolean z) {
        ...
        invokeOnMainThread((Runnable) new C0219i1(this, z, str, i));
    }
    ...
    void sendSurfaceChangedEvent() {
        if (isNativeInitialized()) {
            this.m_MainThread.c(new RunnableC0246r1(this));
        }
    }

    protected void setCharacterLimit(int i) {
        runOnUiThread(new RunnableC0210f1(this, i));
    }

    protected void setHideInputField(boolean z) {
        runOnUiThread(new RunnableC0213g1(this, z));
    }
    ...
    protected void setSelection(int i, int i2) {
        runOnUiThread(new RunnableC0216h1(this, i, i2));
    }

    protected void setSoftInputStr(String str) {
        runOnUiThread(new RunnableC0207e1(this, str));
    }
