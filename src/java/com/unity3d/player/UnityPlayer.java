...
public abstract class UnityPlayer implements IUnityPlayerLifecycleEvents {
    ...
    private ActivityInfo getActivityInfo() {
        return this.mActivity.getPackageManager().getActivityInfo(this.mActivity.getComponentName(), AbstractC0023h.n);
    }
    ...
    private float getScreenBrightness() {
        ...
        int i = Settings.System.getInt(getContext().getContentResolver(), "screen_brightness", com.aheaditec.talsec.security.p1.h);
    ...
    public void configurationChanged(Configuration configuration) {
        ...
        if ((iDiff & 256) != 0 || (iDiff & 1024) != 0 || (iDiff & 2048) != 0 || (iDiff & AbstractC0023h.n) != 0) {
    ...
    ApplicationInfo getApplicationInfo() {
        return this.mContext.getPackageManager().getApplicationInfo(this.mContext.getPackageName(), AbstractC0023h.n);
    }
    ...
    protected void toggleGyroscopeSensor(boolean z) {
        ...
        V0 v0 = this.m_FakeListener;
        if (z) {
            sensorManager.registerListener(v0, defaultSensor, 1);
        } else {
            sensorManager.unregisterListener(v0);
        }
    }
