...
public final class InputDeviceData {
    ...
    public static /* synthetic */ InputDeviceData copy$default(InputDeviceData inputDeviceData, String str, String str2, int i, Object obj) {
        if ((i & 1) != 0) {
            str = inputDeviceData.name;
        }
        if ((i & 2) != 0) {
            str2 = inputDeviceData.vendor;
        }
        return inputDeviceData.copy(str, str2);
    }
    ...
    public final InputDeviceData copy(String str, String str2) {
        Intrinsics.checkNotNullParameter(str, "name");
        Intrinsics.checkNotNullParameter(str2, "vendor");
        return new InputDeviceData(str, str2);
    }
    ...
    public InputDeviceData(String str, String str2) {
        Intrinsics.checkNotNullParameter(str, "name");
        Intrinsics.checkNotNullParameter(str2, "vendor");
        this.name = str;
        this.vendor = str2;
