 ...
 */
/* JADX INFO: renamed from: com.aheaditec.talsec.security.g, reason: case insensitive filesystem */
/* JADX INFO: loaded from: /storage/emulated/0/Documents/jadec/sources/com.TrassGames.G2Companion/dex-files/0.dex */
public abstract class AbstractC0020g extends AbstractC0017f {
    public static final String m;
    public final E1 l;

    static {
        byte[] bArr = {97, -66, 126, -64, 115, 84, 89};
        b(bArr, new byte[]{-18, 10, -13, -91, 28, 48, 60, 20});
        m = new String(bArr, StandardCharsets.UTF_8).intern();
    }

    public AbstractC0020g(R0 r0, E1 e1) {
        super(r0);
        this.l = e1;
    }
    ...
    public void a(X x) {
        this.l.a().c();
        byte[] bArr = {-19, 25, 56, 71, -2, -7, 48};
        b(bArr, new byte[]{114, -84, 56, 35, -111, -99, 85, -50});
        Charset charset = StandardCharsets.UTF_8;
        a(new String(bArr, charset).intern(), x);
        if (x.c()) {
            byte[] bArr2 = {-30, 101, -128, 75, -5, 81, 92};
            b(bArr2, new byte[]{111, 48, -32, 31, -108, 53, 57, -1});
            a(new String(bArr2, charset).intern(), this.l.a().c());
        }
        if (x.b()) {
            E1 e1 = this.l;
            Integer numC = e1.a().c();
            byte[] bArr3 = {44, -72, -111, -127, 100, -47, -35};
            b(bArr3, new byte[]{49, 13, -46, -27, 11, -75, -72, -61});
            e1.a(numC, new String(bArr3, charset).intern());
        }
    }
