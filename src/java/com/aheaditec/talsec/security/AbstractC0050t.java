 ...
 */
/* JADX INFO: renamed from: com.aheaditec.talsec.security.t, reason: case insensitive filesystem */
/* JADX INFO: loaded from: /storage/emulated/0/Documents/jadec/sources/com.TrassGames.G2Companion/dex-files/0.dex */
public abstract class AbstractC0050t extends AbstractC0017f {
    public static final String m;
    public final E1 l;

    static {
        byte[] bArr = {116, -11, 41, 27, -44, -2, -34, -115, -66, 11};
        b(bArr, new byte[]{-16, -59, 69, -105, -102, -64, -105, -2, -47, 127});
        m = new String(bArr, StandardCharsets.UTF_8).intern();
    }

    public AbstractC0050t(R0 r0, E1 e1) {
        super(r0);
        this.l = e1;
    }
    ...
    public void a(X x) {
        this.l.a().n();
        byte[] bArr = {-79, 112, 115, -13, -22, -77, 24, 108, 24, -127};
        b(bArr, new byte[]{-85, 67, -21, -82, 120, 13, 86, 29, 119, -11});
        Charset charset = StandardCharsets.UTF_8;
        a(new String(bArr, charset).intern(), x);
        if (x.c()) {
            byte[] bArr2 = {-106, 103, -1, 63, -109, -29, -45, 24, 64, -1};
            b(bArr2, new byte[]{-50, 52, 119, 115, -33, -67, -118, -119, 47, -117});
            b(new String(bArr2, charset).intern(), this.l.a().n());
        }
        if (x.b()) {
            E1 e1 = this.l;
            Integer numN = e1.a().n();
            byte[] bArr3 = {-9, 100, -113, 114, 72, -120, 69, -66, 110, -50};
            b(bArr3, new byte[]{109, 55, -25, 48, 22, 22, 33, -17, 1, -70});
            e1.a(numN, new String(bArr3, charset).intern());
        }
    }
