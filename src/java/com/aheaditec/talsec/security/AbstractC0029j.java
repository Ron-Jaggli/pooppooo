 ...
 */
/* JADX INFO: renamed from: com.aheaditec.talsec.security.j, reason: case insensitive filesystem */
/* JADX INFO: loaded from: /storage/emulated/0/Documents/jadec/sources/com.TrassGames.G2Companion/dex-files/0.dex */
public abstract class AbstractC0029j extends AbstractC0017f {
    ...
    static {
        byte[] bArr = {-7, -48, -23, 67, 88};
        b(bArr, new byte[]{-11, -47, 52, -51, 43, -1, 123, -55});
        n = new String(bArr, StandardCharsets.UTF_8).intern();
    }

    public AbstractC0029j(R0 r0, u1 u1Var, E1 e1) {
        super(r0);
        this.l = u1Var;
        this.m = e1;
    }
    ...
    public void a(X x) {
        ...
        this.m.a().k();
        this.l.a(t1.a.i, x.b());
        byte[] bArr = {-28, -10, 62, -49, 89};
        b(bArr, new byte[]{-32, -117, -33, 90, 42, -39, 81, 37});
        Charset charset = StandardCharsets.UTF_8;
        a(new String(bArr, charset).intern(), x);
        if (x.c()) {
            byte[] bArr2 = {-127, 90, 118, -41, -103};
            b(bArr2, new byte[]{77, 39, -121, 82, -22, 120, 37, 0});
            a(new String(bArr2, charset).intern(), this.m.a().k(), false);
        }
        if (x.b()) {
            E1 e1 = this.m;
            Integer numK = e1.a().k();
            byte[] bArr3 = {-41, -93, -2, 114, -25};
            b(bArr3, new byte[]{19, -2, 31, -66, -108, -54, 48, 24});
            e1.a(numK, new String(bArr3, charset).intern());
        }
    }
